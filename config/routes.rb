Rails.application.routes.draw do  
  ...
  resources :ecol_transactions do
    ...
    member do
      get :override_transaction_add_to_approval 
      get :override_transaction
      get :pending_validation
      get :approve_ecol_trans
    end
  end
  ...
  get '/ecol_customer/:id/approve' => "ecol_customers#approve"
  get '/ecol_remitter/:id/approve' => "ecol_remitters#approve"
  get '/ecol_rule/:id/approve' => "ecol_rules#approve"
  get '/ecol_transactions/:id/ecol_audit_logs/:step_name' => 'ecol_transactions#ecol_audit_logs'
  get '/ecol_transactions/:id/approve' => "ecol_transactions#approve_transaction"
  ...
  get '/ecol_app_udtables/:id/approve' => "ecol_app_udtables#approve"
  get '/ecol_apps/:id/audit_logs' => 'ecol_apps#audit_logs'
  get '/ecol_apps/:id/approve' => "ecol_apps#approve"
  get '/udf_attribute/:id/audit_logs' => 'udf_attributes#audit_logs'
  get '/udf_attribute/:id/approve' => "udf_attributes#approve"
