Rails.application.routes.draw do  
  ...
  post '/ecol_rule/:id/audit_logs' => 'ecol_rules#audit_logs'
  post '/ecol_customer/:id/audit_logs' => 'ecol_customers#audit_logs'
  post '/ecol_remitter/:id/audit_logs' => 'ecol_remitters#audit_logs'
  ...
  post '/ecol_apps/:id/audit_logs' => 'ecol_apps#audit_logs'
