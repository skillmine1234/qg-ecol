class EcolVaAuditStepDecorator < ApplicationDecorator

  delegate_all

  def step_name
    h.render partial: 'shared/backend', locals: {id: "#{object.class.name.demodulize}_step_name_#{object.id}", object: object}
  end
