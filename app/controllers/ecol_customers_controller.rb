class EcolCustomersController < ApplicationController
  ...
  :pool_acct_no, :app_code, :identity_user_id, :should_prevalidate,:sub_member_bank,:sub_member_bank_ifsc, {allowed_operations: []}, :rmtr_pass_template_id, :rmtr_return_template_id,:autoreturn_validationfailed,:validate_process_by,:notify_process_by,:notify_retry_count,:validate_retry_count,:return_on_credit_failed)
  end
end
