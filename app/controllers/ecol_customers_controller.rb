class EcolCustomersController < ApplicationController
  ...
  :pool_acct_no, :app_code, :identity_user_id, :should_prevalidate,:sub_member_bank,:sub_member_bank_ifsc, {allowed_operations: []}, :rmtr_pass_template_id, :rmtr_return_template_id,:validation_failed_auto_return)
  end
end
