class CreateEcolPendingVaTransfers < ActiveRecord::Migration
  def change
    create_table :ecol_pending_va_transfers, {:sequence_start_value => '1 cache 20 order increment by 1'} do |t|
      ...
      t.index([:broker_uuid, :created_at], :name => 'ecol_pending_va_transfers_01')
    end
  end
end
